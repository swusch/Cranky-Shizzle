...
/**
 * Female Metallurgist citizen model.
 * <p>
 * Same visor mechanic as the male variant – flips down when working,
 * rests on forehead when idle. Texture sheet: 128×64.
 */
public class FemaleMetallurgistModel extends CitizenModel<AbstractEntityCitizen> {

    public FemaleMetallurgistModel(final ModelPart root) {
        super(root);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh() {
        ...
        // Visor – resting position (forehead)
